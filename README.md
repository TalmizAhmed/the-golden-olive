...
## Environments
- Preview: https://main--the-golden-olive--TalmizAhmed.hlx.page/
- Live: https://main--the-golden-olive--TalmizAhmed.hlx.live/
...
1. Open the `the-golden-olive` directory in your favorite IDE and start coding :)
